...
public class SecurityTest {
    ...
    public void sm2sign() throws Exception {
        ...
        SM2SignVO sign = SM2SignUtils.Sign2SM2(Util.hexStringToBytes(privatekey), Util.hexToByte(src));
        ...
        SM2SignVO verify = SM2SignUtils.VerifySignSM2(Util.hexStringToBytes(publicKey), Util.hexToByte(src), Util.hexToByte(SecurityTestAll.SM2SignHardToSoft(signYJ)));
