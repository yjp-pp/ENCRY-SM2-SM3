...
import cn.xjfme.encrypt.utils.sm2.SM2Key;
...
public class SecurityTestAll {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SM2Key sm2KeyVO = generateSM2Key();
    ...
    //产生非对称秘钥
    public static SM2Key generateSM2Key() throws IOException {
        SM2Key sm2KeyVO = SM2Utils.generateKeyPair();
        return sm2KeyVO;
    }
    ...
    public static SM2SignVO genSM2Signature(String priKey, String sourceData) throws Exception {
        SM2SignVO sign = SM2SignUtils.Sign2SM2(Util.hexToByte(priKey), Util.hexToByte(sourceData));
        return sign;
    }
    ...
    public static boolean verifySM2Signature(String pubKey, String sourceData, String hardSign) {
        SM2SignVO verify = SM2SignUtils.VerifySignSM2(Util.hexStringToBytes(pubKey), Util.hexToByte(sourceData), Util.hexToByte(hardSign));
