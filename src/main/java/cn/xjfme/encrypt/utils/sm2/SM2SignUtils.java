...
public class SM2SignUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		SM2SignVO sign = SM2SignUtils.Sign2SM2(Util.hexStringToBytes(privatekey), sourceData);
		SM2SignVO verify = SM2SignUtils.VerifySignSM2(Util.hexStringToBytes(publicKey), sourceData,
				Util.hexStringToBytes(sign.getSm2_signForSoft()));
